...
export default function ToursPage() {
  ...
  const [priceRange, setPriceRange] = useState<[number, number]>([20000, 200000]);
                ...
                <div className="space-y-4">
                  <div className="relative">
                    <div className="h-2 bg-[#3a2a27] rounded-lg relative">
                      <div
                        ...
                        style={{
                          left: `${((priceRange[0] - 20000) / (200000 - 20000)) * 100}%`,
                          width: `${((priceRange[1] - priceRange[0]) / (200000 - 20000)) * 100}%`,
                        }}
                      />
                    </div>
                    <input
                  ...
                  <div className="flex gap-4">
                    <input
                      type="number"
                      value={minPrice}
                      onChange={(e) => handlePriceChange("min", parseInt(e.target.value) || 20000)}
                      className="w-full rounded-lg bg-[#3a2a27] border border-[#4a3a35] p-2 text-sm text-gray-200"
                    />
                    <input
                      type="number"
                      value={maxPrice}
                      onChange={(e) => handlePriceChange("max", parseInt(e.target.value) || 200000)}
                      className="w-full rounded-lg bg-[#3a2a27] border border-[#4a3a35] p-2 text-sm text-gray-200"
                    />
                  </div>
